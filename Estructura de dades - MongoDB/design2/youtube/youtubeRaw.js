        ...
        $jsonSchema: {
            ...
            properties: {
                ...
                playlists: {
                    ...
                    items: {
                        bsonType: "object",
                        required: ["playlist_id", "name", "date", "state"],
                        properties: {
                            playlist_id: {
                                bsonType: "number"
                            },
...
db.users.insertMany([
    { user_id: 1, name: "nom1", email: "nom1@gmail.com", password: "password1", birthday: new Date("1994-07-15"), gender: 2, country: "country1", postal_code: 08001, channel_description: "description1", channel_date: new Date("2020-01-10"), channel_subscriptions: [
        { sub_id: 1, user_id: 2, channel_id: 1 },
        { sub_id: 2, user_id: 3, channel_id: 1 }
    ], playlists: [
        { playlist_id: 1, name: "name1", date: new Date("2020-02-03"), state: 1 }
    ] },
    { user_id: 2, name: "nom2", email: "nom2@gmail.com", password: "password2", birthday: new Date("1994-07-16"), gender: 1, country: "country2", postal_code: 08002, channel_description: "description2", channel_date: new Date("2020-01-11"), playlists: [
        { playlist_id: 2, name: "name2", date: new Date("2020-02-04"), state: 2 }
    ] },
