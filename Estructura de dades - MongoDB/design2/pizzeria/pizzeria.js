          ...
          items: {
            ...
            properties: {
              ...
              lliurament: {
                ...
                maximum: 1,
                description:
                  "1 repartiment a domicili, 0 per a recollir en botiga",
              },
              botiga_id: {
                bsonType: "number",
              },
...
db.clients.insertMany([
  {
    ...
    tiquets: [
      {
        tiquet_id: 1,
        data_hora: new Date("2020-01-01T16:59:59.001Z"),
        lliurament: 1,
        botiga_id: 1,
        empleat_id: 2,
        data_hora_lliurament: new Date("2020-01-01T17:59:59.001Z"),
        comandes: [
          {
            producte_id: 2,
            quantitat: 1,
  ...
  },
  {
    ...
    tiquets: [
      {
        tiquet_id: 6,
        data_hora: new Date("2020-02-01T18:00:00.001Z"),
        lliurament: 1,
        botiga_id: 1,
        empleat_id: 2,
        comandes: [
  ...
  },
  {
    ...
    tiquets: [
      {
        tiquet_id: 3,
        data_hora: new Date("2020-01-02T18:00:00.001Z"),
        lliurament: 0,
        botiga_id: 2,
        empleat_id: 3,
        comandes: [
  ...
  },
  {
    ...
    tiquets: [
      {
        tiquet_id: 4,
        data_hora: new Date("2020-01-02T18:30:30.001Z"),
        lliurament: 1,
        botiga_id: 2,
        empleat_id: 4,
        data_hora_lliurament: new Date("2020-01-02T19:00:00.001Z"),
        comandes: [
          {
            producte_id: 4,
            quantitat: 1,
  ...
  },
  {
    ...
    tiquets: [
      {
        tiquet_id: 5,
        data_hora: new Date("2020-01-03T18:00:00.001Z"),
        lliurament: 0,
        botiga_id: 1,
        empleat_id: 1,
        client_id: 5,
  ...
  },
  {
    ...
    tiquets: [
      ...
      {
        tiquet_id: 8,
        data_hora: new Date("2020-03-01T18:00:00.001Z"),
        lliurament: 0,
        botiga_id: 2,
        empleat_id: 3,
        client_id: 6,
          ...
          items: {
            ...
            properties: {
              ...
              tipus_empleat: {
                ...
                maximum: 1,
                description:
                  "must be a number between 0 (cuiner) & 1 (repartidor)",
              },
            },
          },
        },
...
db.clients
  .find({
    "tiquets.botiga_id": 2,
    $or: [
      { "tiquets.comandes": { $elemMatch: { producte_id: 6 } } },
      { "tiquets.comandes": { $elemMatch: { producte_id: 7 } } },
    ],
  })
  .pretty();
