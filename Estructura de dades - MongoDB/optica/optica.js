...
db.empleats.insertMany([
    { empleat_id: 1, nom: "Oscar" },
    { empleat_id: 2, nom: "Mario" },
    { empleat_id: 3, nom: "David" },
    { empleat_id: 4, nom: "Jessica" },
    { empleat_id: 5, nom: "Marta" }
])
...
db.clients.insertMany([
    { client_id: 1, nom: "nom1", address: "address1", telefon: 123456781, correu: "nom1@gmail.com", data_registre: new Date("2020-01-30") },
    { client_id: 2, nom: "nom2", address: "address2", telefon: 123456782, correu: "nom2@gmail.com", data_registre: new Date("2020-02-02") },
    { client_id: 3, nom: "nom3", address: "address3", telefon: 123456783, correu: "nom3@gmail.com", data_registre: new Date("2020-03-12") },
    { client_id: 4, nom: "nom4", address: "address4", telefon: 123456784, correu: "nom4@gmail.com", data_registre: new Date("2020-04-30"), recomenat: 1 },
    { client_id: 5, nom: "nom5", address: "address5", telefon: 123456785, correu: "nom5@gmail.com", data_registre: new Date("2020-05-03"), recomenat: 2 },
    { client_id: 6, nom: "nom6", address: "address6", telefon: 123456786, correu: "nom6@gmail.com", data_registre: new Date("2020-05-08"), recomenat: 3 },
    { client_id: 7, nom: "nom7", address: "address7", telefon: 123456787, correu: "nom7@gmail.com", data_registre: new Date("2020-06-02"), recomenat: 4 },
    { client_id: 8, nom: "nom8", address: "address8", telefon: 123456788, correu: "nom8@gmail.com", data_registre: new Date("2020-06-10") },
    { client_id: 9, nom: "nom9", address: "address9", telefon: 123456789, correu: "nom9@gmail.com", data_registre: new Date("2020-06-15"), recomenat: 1 },
    { client_id: 10, nom: "nom10", address: "address10", telefon: 123456771, correu: "nom10@gmail.com", data_registre: new Date("2020-06-20"), recomenat: 1 }
])
...
db.createCollection("ulleres", {
    validator: {
        $jsonSchema: {
            bsonType: "object",
            required: ["ullera_id", "graduacio_vidre1", "graduacio_vidre2", "tipus_montura", "color_montura", "color_vidres", "preu", "proveidor_id", "marca_id", "client_id", "empleat_id", "factura_date"],
            properties: {
                ullera_id: {
                    bsonType: "number"
                },
